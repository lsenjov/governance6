...
6. **Note-body abuse** — very long notes or flooding, especially given no self-deletion.
...
7. **Scope creep onto call queue and ledger entries** — temptation to add notes on every entity.
